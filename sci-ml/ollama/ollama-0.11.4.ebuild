...
src_compile() {
	...
	GOFLAGS+=" -buildmode=pie -mod=readonly -modcacherw '-ldflags=-linkmode=external -w -s \"-X=github.com/ollama/ollama/version.Version=$VERSION\" \"-X=github.com/ollama/ollama/server.mode=release\"'"
