#!/usr/bin/env bash
# Usage: ./gen-manifest.sh MANIFEST_FILE TYPE PATH_OR_URL [DEST_FILENAME]
# Example: ./gen-manifest.sh manifest DIST https://example.com/file.tar.gz
#          ./gen-manifest.sh manifest EBUILD /path/to/file.ebuild custom_name.ebuild
