...
src_install() {
    ...
    doins ${S}/nemo-extension/nemo-audio-tab.py
    fperms +x /usr/share/nemo-python/extensions/nemo-audio-tab.py
    insinto /usr/share/nemo-audio-tab
    doins ${S}/nemo-extension/nemo-audio-tab.glade
    fperms +x /usr/share/nemo-audio-tab/nemo-audio-tab.glade
}
